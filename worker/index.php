...
{
$ret=mysqli_query($bd, "SELECT * FROM workers WHERE userEmail='".$_POST['email']."' and password='".$_POST['password']."'");
...
$query=mysqli_query($bd, "SELECT * FROM workers WHERE userEmail='$email' and contactNo='$contact'");
